...
func (x *ExportRequest) GetPollId() int32 {
	if x != nil {
		return x.PollId
	}
	return 0
...
const file_proto_report_proto_rawDesc = "" +
	"\n" +
	"\x12proto/report.proto\x12\x02pb\"@\n" +
	"\rExportRequest\x12\x17\n" +
	"\apoll_id\x18\x01 \x01(\x05R\x06pollId\x12\x16\n" +
	"\x06format\x18\x02 \x01(\tR\x06format\"F\n" +
	"\x0eExportResponse\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontent\x12\x1a\n" +
	"\bfilename\x18\x02 \x01(\tR\bfilename2H\n" +
	"\rReportService\x127\n" +
	"\x0eGenerateReport\x12\x11.pb.ExportRequest\x1a\x12.pb.ExportResponseB\x06Z\x04./pbb\x06proto3"
...
var file_proto_report_proto_depIdxs = []int32{
	0, // 0: pb.ReportService.GenerateReport:input_type -> pb.ExportRequest
	1, // 1: pb.ReportService.GenerateReport:output_type -> pb.ExportResponse
