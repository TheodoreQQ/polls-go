...
const (
	ReportService_GenerateReport_FullMethodName = "/pb.ReportService/GenerateReport"
)
...
type ReportServiceClient interface {
	GenerateReport(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (*ExportResponse, error)
}
...
func (c *reportServiceClient) GenerateReport(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (*ExportResponse, error) {
...
type ReportServiceServer interface {
	GenerateReport(context.Context, *ExportRequest) (*ExportResponse, error)
...
func (UnimplementedReportServiceServer) GenerateReport(context.Context, *ExportRequest) (*ExportResponse, error) {
...
func _ReportService_GenerateReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GenerateReport(ctx, req.(*ExportRequest))
	}
